...
enum class StringKey {
    ...
    REGISTRATION_VERDICT_ERROR_WORD,
    ...
    ZONE_ALLOWED_POINT,
    ZONE_ALLOWED_ENTRY_LABEL,
    ZONE_ALLOWED_ENTRY_FIRST,
    ZONE_ALLOWED_ENTRY_REPEAT,
...
internal val englishStrings = mapOf(
    ...
    StringKey.SERVER_URL_RESET_TO_DEFAULT to "Reset to default",
    ...
    StringKey.REGISTRATION_VERDICT_ERROR_WORD to "ERROR",
    ...
    StringKey.ZONE_ALLOWED_ENTRY_LABEL to "Entry",
    StringKey.ZONE_ALLOWED_ENTRY_FIRST to "First time",
    StringKey.ZONE_ALLOWED_ENTRY_REPEAT to "Repeat",
...
internal val russianStrings = mapOf(
    ...
    StringKey.SERVER_URL_RESET_TO_DEFAULT to "Сбросить по умолчанию",
    ...
    StringKey.REGISTRATION_VERDICT_ERROR_WORD to "ОШИБКА",
    ...
    StringKey.ZONE_ALLOWED_ENTRY_LABEL to "Вход",
    StringKey.ZONE_ALLOWED_ENTRY_FIRST to "Впервые",
    StringKey.ZONE_ALLOWED_ENTRY_REPEAT to "Повторно",
