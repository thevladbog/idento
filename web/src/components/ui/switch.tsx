...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=unchecked]:bg-slate-200 data-[state=unchecked]:border-slate-300 dark:data-[state=unchecked]:bg-slate-700 dark:data-[state=unchecked]:border-slate-600",
      className
    )}
    {...props}
    ref={ref}
