...
import { BarChart3, Building2, ClipboardList, FileText, Receipt, Search, ShoppingCart, Users } from 'lucide-react';
...
export default function SuperAdminLayout() {
  ...
  const menuItems = [
    ...
    { icon: Receipt, label: t('billingInvoices'), path: '/billing/invoices' },
