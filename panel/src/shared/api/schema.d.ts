...
export interface paths {
    ...
    "/api/equipment/printers/pairing-export.csv": {
        ...
        /** CSV of every network printer in the tenant's registry with a ready qr_payload column, for bulk label generation in an external tool. UTF-8 with BOM; one row per network printer. */
        get: operations["exportPrinterPairingCSV"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
