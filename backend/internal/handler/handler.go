...
func (h *Handler) RegisterRoutes(e *echo.Echo, mode string) {
	...
	api.GET("/events/:id/checkin-settings", h.GetCheckinSettings)
	api.PUT("/events/:id/checkin-settings", h.PutCheckinSettings)
	api.POST("/events/:event_id/checkin-stations", h.RegisterCheckinStation)
	api.GET("/events/:event_id/checkin-stations", h.ListCheckinStations)
	api.POST("/events/:event_id/checkin-stations/:id/heartbeat", h.HeartbeatCheckinStation)
